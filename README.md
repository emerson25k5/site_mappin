...
├── Imagens/             # Recursos visuais e imagens do site
├── materialize/         # Arquivos da biblioteca Materialize CSS
├── conecta_mappin.php   # Script de conexão com o banco de dados
├── index.php            # Página inicial do e-commerce
├── login.php            # Script de autenticação de usuários
├── cadastrocliente.html # Formulário de registro de novos clientes
├── estiloindex.css      # Estilos personalizados para o site
